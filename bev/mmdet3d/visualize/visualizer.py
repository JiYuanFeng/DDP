...
class Visualizer(object):
    ...
    def visualize_gt_motion(self, motion_labels, save_path=None):
        # visualize BEV instance trajectory
        segmentation_binary = motion_labels['segmentation']
        segmentation = segmentation_binary.new_zeros(
            segmentation_binary.shape).repeat(1, 1, 2, 1, 1)
        ...
        imageio.imwrite('{}/motion_gt_1.png'.format(save_path),figure_motion_label)
        # imageio.imwrite('{}/motion_gt_2.png'.format(save_path),
        #                flip_rotate_image(figure_motion_label))

    def visualize_motion_gif(self, labels=None, output=None, fps=1):
