...
from mmcv.cnn import ConvModule, build_padding_layer, build_conv_layer, build_norm_layer, build_activation_layer, \
...
class ConvWithTimeModule(nn.Module):
    ...
    def __init__(self,
        ...
        self.time_mlp = nn.Sequential(  # [2, 1024]
            nn.SiLU(),
            nn.Linear(time_in_channels, out_channels * 2)  # [2, 512]
...
class FCNHeadWithTime(BaseDecodeHead):
    ...
    def __init__(self,
        ...
        super(FCNHeadWithTime, self).__init__(**kwargs)
        if num_convs == 0:
    ...
    def _forward_feature(self, inputs, times):
    ...
    def forward(self, inputs, times):
        """Forward function."""
        output = self._forward_feature(inputs, times)
